...
<nav class="navbar"> 
     ...
     <ul >
        <li>
            ...
            <li><a href="http://localhost/e_com/e_com/about_us.php">ABOUT</a></li>
            ...
            <!-- <div class="collapse clearfix" id="search">
                ...
                <li>
                  <a href="cart.php" class="">
                   ...
                   <li>
                   <a href="http://localhost/e_com/e_com/admin_area/login.php"><i class="fa fa-user"></i>Admin</a></li>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="info">
            <a href="http://localhost/e_com/e_com/saloon.php"><h3>Trimmer</h3></a>
...
<!-- Trimer End  -->
    ...
    <div class="box">
     ...
     <div class="box">
        <div class="image">
           <a href="trimer.php?p_cat=35"> <img src="website/all/foam.jpg"  alt=""></a>
        </div>
        <div class="info">
        ...
        <div class="wolf">
            ...
            <div class="footer-ol">
                ...
                <ul>
                    ...
                    <li><a href="http://localhost/e_com/e_com/services.php#">our services</a></li><br><br>
            ...
            <div class="footer-ol">
                <h4>get help</h4>
                <ul>
                    <li><a href="http://localhost/e_com/e_com/faq.php">FAQ</a></li><br><br>
            ...
            <p class="credit">Copyright &copy; <span>2024-2024</span> | all rights reserved. | <span>Designed By QuadTeam</span></p>
        </div>
     </div>
  </footer>
