...
<>
    <div class="container">
        <h1>OUR SERVICES</h1>
        <p>WELCOME TO OUR WEBSITE QUAD COSMETICS</p>
        <h2>FOR YOU</h2>
        
            <div class="team-member">
                <h3>BEST PRODUCTS</h3>
                <p>With the color varience</p>
            </div>

            <div class="team-member">
                <h3>CAREER OPTIONS</h3>
                <p>mail us at quadcosmetics@gmail.com</p>
            </div>
            <div class="team-member">
                <h3>NO SHIPPING CHARGE</h3>
                <p>Makes us best performa</p>
            </div>

        <h2>Our History</h2>
        <p>Our Company was founded in 2023.</p>
        <h2>Contact Us</h2>
        <p>If you have any questions or inquiries, feel free to contact us at ds9034355@gmail.com</p>
    </div>
      <div>
...
$receiverEmail="ritikarauthan@gmail.com";
